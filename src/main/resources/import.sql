...
insert into vm_tb(user_id, vmname, password, course_id, port, scope, control, state, description, node_port, created_date) values(1, '알고리즘', '1234', 7, 6000, 1, 1, 'stop', '이 가상환경은 알고리즘 수업을 위한 가상환경이다', 30000, '2023-10-06 12:00:01');
insert into vm_tb(user_id, vmname, password, course_id, port, scope, control, state, description, node_port, created_date) values(1, '알고리즘1', '1234', 7, 6001, 1, 1, 'running', '이 가상환경은 알고리즘 수업을 위한 가상환경이다', 30001, '2023-10-06 12:00:02');
insert into vm_tb(user_id, vmname, course_id, port, scope, control, state, description, node_port, created_date) values(2, '알고리즘059', 7, 6002, 7, 0, 'running', '알고리즘 059수업', 30002, '2023-10-06 12:00:03');
insert into vm_tb(user_id, vmname, course_id, port, scope, control, state, description, node_port, created_date) values(2, '네트워크', 10, 6003, 1, 1, 'stop', '이 가상환경은 네트워크 공부를 위한 가상환경이다. 지금은 사용하지 않고 있지만, 추후에 많이 수정할 예정이다.', 30003, '2023-10-06 12:00:04');
