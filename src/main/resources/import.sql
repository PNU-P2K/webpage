...
--insert into vm_tb(user_id, vmname, cousrdid, port, scope, control, state) values(2, '알고리즘', 1, 6085, 1, 1, 'stop');
--insert into vm_tb(user_id, vmname, cousrdid, port, scope, control, state) values(2, '자료구조', 1, 6086, 0, 1, 'stop');
--insert into vm_tb(user_id, vmname, cousrdid, port, scope, control, state) values(3, '알고리즘', 1, 6087, 1, 1, 'stop');
--insert into vm_tb(user_id, vmname, cousrdid, port, scope, control, state) values(3, '자료구조', 1, 6088, 0, 1, 'stop');
